...
Приложения предназначено для корректной реализации и контроля пользователей и ресурсов "Книжного клуба", администрацией выше названного клуба.
### <a name="P1.2">1.2. Бизнес-требования</a>
Приложение представляет собой окно для работы администратором клуба, на главной странице имеются две рабочие кнопки выбора, по которым администратор может перейти в меню работы с участниками клуба или же с ресурсами (книгами) клуба.
### <a name="P1.3">1.3. Аналоги</a>
Аналоги приложения отсутствуют, так как является заточеным под узкий круг пользователей.
